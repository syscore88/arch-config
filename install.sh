...
AUR_PKGS=(ventoy-bin google-chrome brave-origin-bin faugus-launcher-bin opencode-desktop-bin shelly-flatpak-backend-bin dmemcg-booster needrestart makeself)
